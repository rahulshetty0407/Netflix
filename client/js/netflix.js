console.log("hello");
//var participantsField = document.getElementById("abc");
 //participantsField.
function multiplyNode(count, deep) {
	//console.log(participantsField.name);
	//document.getElementById("demo").innerHTML = "Hello JavaScript!";
	//document.getElementById('movie').src='http://ia.media-imdb.com/images/M/MV5BMjIzMDI4MTUzOV5BMl5BanBnXkFtZTcwNDY3NjA3Mg@@._V1_SX300.jpg';
   // for (var i = 0; i < count - 1; i++) {
     //   var copy = participantsField.cloneNode(deep);
        //node.parentNode.insertBefore(copy, node);
		//participantsField.appendChild(copy);
		//participantsField.insertBefore(copy,participantsField);
   // }
}
